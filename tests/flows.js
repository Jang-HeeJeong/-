...
window.FLOW_CASES = [
  ...
  {
    id: 'flow-ch3-apap-600-boundary',
    desc: '아세트아미노펜 1일 700mg — 5번(하한 1/2=750)은 위반, 6번(하한 600)은 통과',
    steps: [
      { pick: '캐롤비콜드연질캡슐' },
      { setAmt: 2 },
      // 1회 116.6667mg × 2캡슐 × 3회 = 1일 700mg
      { setDoseByName: { '아세트아미노펜': 116.6667 } },
      // 두 조항을 묶어 처리하면 6번까지 X가 된다 — 따로 보는지 확인
