...
Geist는 Google Fonts에 없습니다. 빌드 없이 쓰려면 대체 폰트를 씁니다.

```css
--font-geist-sans: 'Geist', 'Pretendard', 'Inter', -apple-system, 'Malgun Gothic', sans-serif;
--font-geist-mono: 'Geist Mono', 'JetBrains Mono', 'D2Coding', Consolas, monospace;
```
